"""Genome encoding: maps to BZ AdvancedOptions JSON."""
...
@dataclass
class Genome:
    """Full parameter set for one BZ compression invocation."""
    ...
    def to_cli_args(self, input_path: str, output_path: str,
        ...
        """Build command-line argument list for bz compress."""
    ...
    def to_json_config(self) -> dict:
        """Build flat dict matching BZ AdvancedOptions JSON structure."""
        config = {}
